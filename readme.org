...
- macOS: 10.14.0, 10.14.1, 10.14.2, 10.14.3 and supp. update (18D109), 10.14.4, 10.14.5
...
- Include [[https://github.com/RehabMan/AppleBacklightFixup][AppleBacklightFixup]] [[file:EFI/CLOVER/kexts/Other/AppleBacklightFixup.kext][kext]]
- +Include [[file:EFI/CLOVER/ACPI/patched/SSDT-PNLF.aml][SSDT-PNLF.aml]] ([[file:EFI/CLOVER/ACPI/patched/SSDT-PNLF.dsl][SSDT-PNLF.dsl]])+
- Include [[file:EFI/CLOVER/ACPI/patched/SSDT-PNLFCFL.aml][SSDT-PNLFCFL.aml]] ([[file:EFI/CLOVER/ACPI/patched/SSDT-PNLFCFL.dsl][SSDT-PNLFCFL.dsl]]); possibly temporary until fix is included in SSDT-PNLF.
...
- [[file:EFI/CLOVER/ACPI/patched/SSDT-PNLFCFL.aml][SSDT-PNLFCFL.aml]] is already included in step above
...
** Battery status
- Install [[https://github.com/RehabMan/OS-X-ACPI-Battery-Driver][ACPIBatteryManager]] [[file:EFI/CLOVER/kexts/Other/ACPIBatteryManager.kext][kext]]
...
hardware. VirtualSMC is newer and actively maintained, but if you run into problems with it, FakeSMC
seems to cause no issues as well. This repo just switched to VirtualSMC, so if you run into any
problems specific to it, please open an issue.
*** Installation
...
* Change history
*** 2019-05-21: Use VirtualSMC in favor of FakeSMC
